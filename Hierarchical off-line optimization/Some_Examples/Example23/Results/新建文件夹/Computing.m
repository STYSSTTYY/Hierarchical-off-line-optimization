...
hold off;
title('The cumulative amount of computing resources consumption','FontName', 'SimSun', 'FontSize', 12);
set(gca, 'YScale', 'log');
...
ylabel('Computing resources consumption','FontName', 'SimSun', 'FontSize', 12,'Units','pixels',Position=[-24.00000032424931,160.6,0]);
set(gca, 'YScale', 'log');
