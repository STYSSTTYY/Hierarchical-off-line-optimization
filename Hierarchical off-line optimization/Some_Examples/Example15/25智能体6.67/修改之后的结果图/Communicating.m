...
fig = figure('Color',[1,1,1], 'Position', [100, 100, 250, 200]);
ax = axes('Parent', fig, 'Position', [0.1, 0.1, 0.85, 0.8]); % 调整轴的位置和大小

h1 = subplot('Position', [0.15, 0.6, 0.84, 0.3]);
b = zeros(n,1);
hold on;
for i = 1:n
...
hold off;
title('Cumulative communicational cost','FontName', 'Times New Roman', 'FontSize', 10,'Units','pixels',Position=[104.000137424469,60.97999954223636,0]);
set(gca, 'YScale', 'log');
set(gca, 'XTick', groupPositions(1:12, round(n/2))', 'XTickLabel', 1:1:12,'FontSize',9,'FontName', 'Times New Roman');
% 设置图例
...
h2 = subplot('Position', [0.15, 0.2, 0.84, 0.3]);
b = zeros(n,1);
hold on;
for i = 1:n
...
hold off;
xlabel('Agent number','FontName', 'Times New Roman', 'FontSize', 10,'Units','pixels',Position=[105.8000999450684,-21.330361222140503,-0.798806850735755]);
ylabel('Communicational cost', 'FontName', 'Times New Roman', 'FontSize', 10,'Units','pixels',Position=[-20.799862575530994,73.37999954223635,0]);
set(gca, 'YScale', 'log');
set(gca, 'XTick', groupPositions(13:25, round(n/2))', 'XTickLabel', 13:1:25,'FontSize', 9,'FontName', 'Times New Roman');
