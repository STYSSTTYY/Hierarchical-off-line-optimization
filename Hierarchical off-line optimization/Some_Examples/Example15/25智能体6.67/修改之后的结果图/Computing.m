% 打开 .fig 文件
fig = openfig('算力消耗.fig', 'invisible');
...
hold off;
title('Cumulative computational cost','FontName', 'Times New Roman', 'FontSize', 10,'Units','pixels',Position=[104.000137424469,60.97999954223636,0]);
set(gca, 'YScale', 'log');
...
ylabel('Computational cost','FontName', 'Times New Roman', 'FontSize', 10,'Units','pixels',Position=[-20.799862575530994,73.37999954223635,0]);
set(gca, 'YScale', 'log');
