function C__ = Find_The_Position_Of_Certain_SigSquare_And_Modification(i,k,Carrier_i,C,A,S,X,P,X_Carrier_i)
    ...
    for j = 1:m
        if G(j,Carrier_i) == 1
            ...
            if (If_Relative) + (Object==k) + (Sender==i) == 3
                [Row1,Row2] = Find_The_Row_Position_Of_H(Carrier_i,j,A,S);
                if Dimension == 1
