function [Flag2,Carriers_Number,X_Carrier_Number_All] = Check_A_S_Comcentration(i,A,S)
% 根据未知数个数与方程条数的对应，找出对于运算中心i，哪些载体应该解算出来而没有解算出来，以及能不能解算出来的载体的编号，不能解算出来为1，能为0
    ...
    Carriers_Number3 = Find_Which_Carrier_Failed3_Comcentration(i,A,S);  % 改！还有一些情况
