...
% 根据动作计算每一步的通讯代价 将收到的和发送的数据量分开计算。 
    ...
    for i = 1:Num
        ...
        for k = 1:Num  % 这边考虑协方差的传输
            ...
            Cost(1,Sender_Carrier) = Cost(1,Sender_Carrier) + Data_Size_Cross_Covariance_Matrix(Cross_Covariance_Matrix_i);  % 计算要传输的互协方差矩阵的通信代价
            Cost(1,Receivor_Carrier) = Cost(1,Receivor_Carrier) + Data_Size_Cross_Covariance_Matrix(Cross_Covariance_Matrix_i);
        end
    end
